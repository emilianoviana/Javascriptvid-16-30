...
let nilai = [
    ...
    {nama:"bright", ipa:80, bahasa:90, matematika:60},
    {nama:"jerome", ipa:75, bahasa:70, matematika:90},
    {nama:"farhan", ipa:90, bahasa:80, matematika:90},
];

let nama = ["budi", "bright", "jerome", "farhan"];
//nama.push("ani", "roma");
